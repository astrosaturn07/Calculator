...
while True:
    ...
    print("Enter 6 to calculate floor division of a number ")
    print("Enter 7 to calculate modulus of a number ")
       ...
       print("The multiplication is" , multiplication)
        ...
        if(Num==1):
          print("The log of n1 is", math.log(n1),"The log of n2 is", math.log(n2) )
            ...
            print("The sin of n1 is", math.sin(n1),"The cos of n2 is", math.sin(n2)) 
